...
@NgModule({
  declarations: [InviteToPlatformComponent, EmailTemplateInviteComponent, EmailTemplateRegistrationApprovedComponent, InviteDependentToPlatformComponent, FEmailTemplateComponent],
