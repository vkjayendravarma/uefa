...
export class EventEditComponent implements OnInit {
  ...
  async setupEvent() {
    ...
    globalEventCategories: any = await this.http.post(this.apiLink + 'event/get_global_event_category', {}, {headers: headers}).toPromise(),
    globalEventRegions: any = await this.http.post(this.apiLink + 'event/get_global_event_region', {}, {headers: headers}).toPromise(),
    globalInstituteTypes: any = await this.http.post(this.apiLink + 'event/get_global_event_inst_type', {}, {headers: headers}).toPromise();
  ...
  setupForm() {
    ...
    this.eventPublishForm = this.fb.group({
      ...
      link: [event.event_link, Validators.required]
    });
